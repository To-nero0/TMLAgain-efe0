[TMLAgain-efe0] Operating Details
====================================

Generated On: 2024-10-17 19:17:46 UTC
...
.. important::
   ...
   **not be valid if your [TMLAgain-efe0] container is NOT running**.

.. tip::
   You must have your [TMLAgain-efe0] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/To-nero0/tonerodocker  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env READTHEDOCS=<Enter your readthedocs token>  \-\-env EXTERNALPORT=44369  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME=To-nero0  \-\-env GITPASSWORD=<Enter personal access token>  \-\-env DOCKERUSERNAME=anthopadua  \-\-env DOCKERPASSWORD=<Enter your docker hub password>  \-\-env MQTTUSERNAME=Anthopadua  \-\-env MQTTPASSWORD=<Enter your mqtt password>  \-\-env KAFKACLOUDUSERNAME=  \-\-env KAFKACLOUDPASSWORD=<Enter your API secret>  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   anthopadua/TMLAgain-efe0-amd64 (https://hub.docker.com/r/anthopadua/TMLAgain-efe0-amd64)
...
.. important::
   docker run -d -p 36569:36569 -p 44225:44225 -p 58991:58991 \-\-env TSS=0 \-\-env SOLUTIONNAME=TMLAgain-efe0 \-\-env SOLUTIONDAG=solution_preprocessing_ai_dag-TMLAgain-efe0 \-\-env GITUSERNAME=To-nero0 \-\-env GITPASSWORD=<Enter Github Password>  \-\-env GITREPOURL=https://github.com/To-nero0/tonerodocker \-\-env SOLUTIONEXTERNALPORT=36569 \-\-env READTHEDOCS=<Enter Readthedocs token> \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=44225  \-\-env SOLUTIONVIPERVIZPORT=58991 \-\-env DOCKERUSERNAME=anthopadua  \-\-env EXTERNALPORT=44369 \-\-env KAFKACLOUDUSERNAME= \-\-env KAFKACLOUDPASSWORD=<Enter API secret>  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME=Anthopadua \-\-env MQTTPASSWORD=<Enter mqtt password>  \-\-env AIRFLOWPORT=9000 anthopadua/TMLAgain-efe0-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=58991
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=36569
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - anthopadua/TMLAgain-efe0-amd64
...
It can be accessed by entering: http://localhost:44225
...
.. important::
   http://localhost:58991/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:58991/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:58991/<html file>
...
[TMLAgain-efe0] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/To-nero0/tonerodocker/tree/main/tml-airflow/dags/tml-solutions/TMLAgain-efe0
...
.. important::
   https://TMLAgain-efe0.readthedocs.io
...
.. important::
   solution_preprocessing_ai_dag-TMLAgain-efe0
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=36569, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41837, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45049, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46543, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37955, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33861, HPDEHOST=127.0.1.1, HPDEPORT=42825, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36557

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3066-TMLAgain-efe0,solution_preprocessing_ai_dag-TMLAgain-efe0, python-preprocess-5254-TMLAgain-efe0,solution_preprocessing_ai_dag-TMLAgain-efe0, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
